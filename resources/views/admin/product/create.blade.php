    ...
    <div class="content-wrapper ">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-3"></div>
                    <div class="col border mb-3 p-0">
                        <label for="category_id"><h3>{{ trans('product_trans.category') }}</h3></label>
                        <select name="category_id" id="category_id" class="form-control">
                            <option value="">
                                {{-- {{ trans('product_trans.please_select') }} --}}
                            </option>
...
<script>
    $('form').on('submit', function(event) {
        ...
        if (categorySelect.val() === '') {
            ...
            alert('{{ trans('product_trans.choise category please') }}');  // عرض الرسالة التحذيرية
        }
    });
</script>
@endsection
