...
@section('content')
<div class="row py-4 " style="margin-top: 76px;background-color: rgba(13, 12, 44, 0.384)">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb px-5">
            <li class="breadcrumb-item" ><a href="{{route('get_categories')}}" style="color: rgb(14,8,109)">{{trans('website_trans.category')}}</a></li>
