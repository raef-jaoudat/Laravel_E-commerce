        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb px-5">
                <li class="breadcrumb-item"><a
                        href="{{route('get_categories')}}" style="color: rgb(14,8,109)">{{trans('website_trans.category')}}</a></li>
                <li class="breadcrumb-item active" aria-current="page" style="color: rgba(15, 8, 109, 0.733)">{{$product->category->slug}}</li>
