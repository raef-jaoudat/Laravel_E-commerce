...
@endsection
@section('content')
    <section class="h-100 " style="background-color: #eee;margin-top: 76px">
                                ...
                                <div class="row d-flex justify-content-between align-items-center">
                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                        <img src="{{ Storage::url($product_cart->Product->image) }}"
                                            ...
                                            style="height: 125px;width: 200px" style="max-width: 200px;max-height: 125px;">
                                    </div>
                                    ...
                                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                        ...
                                        <input id="form1" min="0" name="qty" value="{{ $product_cart->qty }}"
                                            type="number"
